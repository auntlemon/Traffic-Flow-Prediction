...
o_fc1_v3_4 =tf.layers.batch_normalization(o_fc1_v2_4,center=False, scale=True,training=True,fused = True,name='bn4')#name error
...
output,state=tf.nn.dynamic_rnn(cell=lstm_cell_1,inputs=o_fc1_v4_3 ,dtype=tf.float32)
output_v1 = output[:,-1,:]
